...
public class PropertiesLoader {
    ...
    //W klasie znajduje się tylko jedna metoda. Służy ona do odczytywania właściwości z zadanego pliku
    public Properties getPropertiesFromFile(String propertiesFileName) {

        //Tworzymy obiekt InputSteam, który posłuży nam odczytania pliku properties
        ...
        try {
            ...
            // Na sam koniec zamykamy obiekt typu InputStream wywołując prywatną metodę closeResource
            closeResource(inputStream);
        }

        //Metoda zwraca zainicjalizowany obiekt properties
        return properties;
    }
